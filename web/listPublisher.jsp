...
<html>
    ...
    <body id="body-pd">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <h1 id="welcome">Publisher List</h1>
                <div class="form-container">
                    <form action="addPublisher.jsp" method="post">
                        <button type="submit" class="btn btn-primary " id="add">Add Publisher</button>
                    </form>
                </div>
                <div class="message">
                    ...
                    <table  class="table table-hover">
                        ...
                        <tbody>
                            <c:forEach var="entry" items="${listP}">
                                <tr>
                                    <td>${entry.key}</td>
                                    <td><a href="updatePublisher?id=${entry.value.publisher_id}">${entry.value.name}</a></td>
                                    <td>${entry.value.address}</td>
                                    <td>${entry.value.contact}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
