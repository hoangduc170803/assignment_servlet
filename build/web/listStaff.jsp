...
<html>
    ...
    <body id="body-pd">
        ...
        <h1 id="welcome">Staff List</h1>
        <div class="form-container">
            <form action="createStaff.jsp" method="get">
                ...
                <c:choose>
                    <c:when test="${not empty list}">
                        <c:forEach var="entry" items="${list}">
                            <tr>
                                <td>${entry.key}</td>
                                <td><a href="updatestaff?staff_id=${entry.value.staffId}">${entry.value.username}</a></td>
