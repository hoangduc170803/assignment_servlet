...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <h1 id="welcome">Update Publisher</h1>
        ...
        <form action="updatePublisher" method="post">
            ...
            <div class="form-group row" style="margin-bottom: 20px">
                <label for="conttact" class="col-sm-2 col-form-label">Name:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="conttact" name="conttact" value="${publisher.contact}" required>
                </div>
            </div>
        ...
        <div class="form-container">
            <form action="deletePublisher" method="get">
                <input type="hidden" name="id" value="${publisher.publisher_id}">
                <input type="submit" style="margin: 30px" class="btn btn-danger  " value="Delete Publisher">
                </div>
            </form>
            <script>
